          ...
          <thead>
            <tr>
              <th className="prev" onClick={this.props.subtractMonth}>
                <span className={classnames(this.props.iconStyle.class, this.props.iconStyle.left)} />
              </th>
              ...
              <th className="next" onClick={this.props.addMonth}>
                <span className={classnames(this.props.iconStyle.class, this.props.iconStyle.right)} />
              </th>
            </tr>
